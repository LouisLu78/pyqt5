...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBoxAccountType.setGeometry(QtCore.QRect(110, 80, 181, 41))
        ...
        self.labellAccountType = QtWidgets.QLabel(Dialog)
        self.labellAccountType.setGeometry(QtCore.QRect(50, 200, 281, 41))
        self.labellAccountType.setText("")
        self.labellAccountType.setObjectName("labellAccountType")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBoxAccountType.setItemText(3, _translate("Dialog", "Fixed Depostit Account"))
