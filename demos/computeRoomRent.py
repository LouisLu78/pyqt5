# -*- coding: utf-8 -*-
# author: Guangqiang Lu time:2019/12/10

import sys
from PyQt5.QtWidgets import QDialog, QApplication
from demos.reservehotel import *
...
class MyForm(QDialog):
    ...
    def computeRoomRent(self):
        ...
        self.ui.Enteredinfo.setText('Date of reservation:'+dateinstring+ ',\n Number of days: '+
        ...
        self.ui.RoomRentinfo.setText('Room Rent for single day for '+ chosenRoomType +' \ntype is '+
